      ...
      <div className="login-sidebar">
        <div className="sidebar-content">
          ...
          <h1 className="sidebar-title">
            Manage your<br />projects with AI<br />precision.
          </h1>

          <p className="sidebar-subtitle">
            Streamline workflows, automate task assignments, and get real-time insights with our next-gen AI engine.
          </p>
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <div className="social-logins">
              ...
              <button 
                ...
                onClick={() => window.location.href = `${import.meta.env.VITE_BACKEND_URL || 'http://localhost:5001'}/api/auth/github`}
              >
